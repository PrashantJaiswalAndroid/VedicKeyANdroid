...
public class ThirdTryityourself  extends Fragment {
			...
			public void onClick(View v) {
						...
						edt2.getText().toString().equalsIgnoreCase(""))
				{
					...
					alertDialog.show();
						...
						Integer.valueOf(edt1.getText().toString())<90||
						Integer.valueOf(edt2.getText().toString())<90)
				{
					...
					// set dialog message
					alertDialogBuilder
					.setMessage("Please enter numbers i.e. between 90 to 100")
					.setCancelable(false)
					.setPositiveButton("OK",new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,int id) {
							// if this button is clicked, close
